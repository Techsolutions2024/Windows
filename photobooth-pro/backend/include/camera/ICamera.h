...
using LiveViewCallback = std::function<void(const std::vector<uint8_t>&, int width, int height)>;
...
public:
    ...
    virtual void captureWithCountdown(int seconds, CaptureMode mode, CaptureCallback callback) = 0;
